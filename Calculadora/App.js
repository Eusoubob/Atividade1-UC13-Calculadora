  ...
  function calculator() {
    ...
    switch (operator) {
      ...
      case '/':
        setCurrentNumber((fistNumber / lastNumber).toString())
        return
      case '%': // Calculo de porcentagem básica adicionado
        setCurrentNumber((fistNumber * (lastNumber / 100)).toString());
        return
      case '+/-': // Calculo inversão de sinal adicionado
      ...
      <View style={styles.buttons}>
        ...
        {buttons.map((button) =>
          button === '=' ? // Mapeamento do botão =
            <TouchableOpacity onPress={() => handleInput(button)} key={button} style={[styles.button, { backgroundColor: '#000029' }]}>
